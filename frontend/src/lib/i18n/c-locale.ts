...
export const cLocale = {
    ...
    processSteps: [
      {
        num: "01",
        title: "上门评估，商定目标售价",
        description: "专业评估团队上门，结合周边真实成交数据，跟你商量一个写进合同的目标售价。",
      },
      {
        num: "02",
        title: "公司全额垫资装修，65天",
        description: "快速翻新改造，让房子品相大幅提升。业主一分不掏，装修方案需业主确认。",
      },
      {
        num: "03",
        title: "公司全权卖房",
        description: "卖到约定价，业主拿钱；卖不到约定价，装修免费送业主。两种结果，业主都不亏。",
      },
    ],
    // 新增：算账模块
    calculation: {
      ...
      title: "算一笔实在账",
      subtitle: "假设约定价 300 万、装修成本 20 万，看看三种市场情况下的结果",
      cases: [
        {
          scenario: "市场给力",
          soldPrice: "330万",
  ...
  contact: {
    realDataBadge: "真实成交",
    title: "同小区同户型\n看看他们卖了多少",
    subtitle: "每一套都是公司垫资装修、全权卖房的真实案例。成交价、周期，真实可查。",
    recentLabel: "近期成交",
  ...
  login: {
    brandDesc: "美房宝为业主提供零成本、零风险的卖房服务。登录查看你的估价记录与目标售价跟进。",
  ...
  my: {
    ...
    empty: {
      title: "暂无估价记录",
      description: "提交房源信息后，这里会显示你的估价记录、目标售价与顾问跟进",
    },
    goToValuation: "去免费预审",
  },
  ...
  valuation: {
    ...
    quickFaqs: [
      ...
      {
        q: "线上预审和最终约定价什么关系？",
        a: "线上预审只给初步判断。上门看房结合实际状况后，再商定写进合同的约定价格，你有一票否决权。",
      },
    ],
  ...
  projects: {
    ...
    valueProposition:
      "美房宝，每一套房子都值得被认真对待，坚持做品质二手房。精选好房，匠心设计，严选好材，专业服务。",
    shareFallback: "房源",
