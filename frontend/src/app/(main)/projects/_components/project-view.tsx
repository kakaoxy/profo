  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row w-full lg:w-auto gap-3 items-center">
          ...
          >
            <TabsList className="h-10 bg-slate-100/50 p-1 rounded-lg">
              ...
              <TabsTrigger value="signing" className="text-xs px-3 data-[state=active]:bg-blue-100 data-[state=active]:text-blue-800">签约</TabsTrigger>
              <TabsTrigger value="renovating" className="text-xs px-3 data-[state=active]:bg-orange-100 data-[state=active]:text-orange-800">装修</TabsTrigger>
              <TabsTrigger value="selling" className="text-xs px-3 data-[state=active]:bg-purple-100 data-[state=active]:text-purple-800">在售</TabsTrigger>
              <TabsTrigger value="sold" className="text-xs px-3 data-[state=active]:bg-emerald-100 data-[state=active]:text-emerald-800">已售</TabsTrigger>
            </TabsList>
          </Tabs>
        </div>
      ...
      <div className="flex items-center justify-between text-xs text-slate-400 px-1">
        <span>显示 {filteredData.length} 条记录 (共 {total} 条)</span>
      </div>
