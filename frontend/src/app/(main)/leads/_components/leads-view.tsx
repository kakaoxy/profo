    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <div className="w-full max-w-400 mx-auto flex flex-col gap-8 py-8 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-1">
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">线索管理</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">管理和跟进房源线索，从初筛到签约的全流程追踪。</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {isPending && (
            <div className="flex items-center justify-center py-8">
              ...
              <span className="ml-2 text-sm text-slate-500 dark:text-slate-400">{LOADING_TEXT.LOADING}</span>
            </div>
          )}
