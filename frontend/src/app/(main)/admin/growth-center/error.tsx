 ...
 * 获客中心错误边界.
 *
 * 覆盖 overview / leads / funnel / campaigns 子路由，当 Server Component 数据层
 * 抛出错误时展示错误态（含重试入口），与空态可区分。
 */

import { useEffect } from "react";
import { AlertCircle, RefreshCcw } from "lucide-react";

export default function GrowthCenterError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error("[GrowthCenter] Error boundary caught:", error);
  }, [error]);
