...
import type { L4MarketingProject, L4MarketingMedia, PhotoCategory } from "@/app/(main)/admin/l4-marketing/projects/types";
      ...
      <div className="w-full max-w-[1400px] mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <Link href="/admin/l4-marketing/projects">
          ...
          <div className="flex gap-3">
            ...
            <Link href={`/admin/l4-marketing/projects/${project.id}/preview`}>
              <Button variant="outline">
