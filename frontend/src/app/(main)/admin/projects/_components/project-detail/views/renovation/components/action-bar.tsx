...
export function ActionBar({
  ...
  if (!isCompleted && canComplete) {
    return (
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-3 rounded-md mt-4 border bg-status-renovating/10 border-orange-100">
