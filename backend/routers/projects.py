...
from schemas.project import (
    BaseResponse, ProjectCreate, ProjectUpdate, ProjectResponse,
...
async def create_project(
    ...
    return BaseResponse(code=200, msg="success", data=project)
...
@router.put("/{project_id}/status", response_model=BaseResponse[ProjectResponse])
...
@router.post("/{project_id}/complete", response_model=BaseResponse[ProjectResponse])
...
@router.put("/{project_id}/renovation", response_model=BaseResponse[ProjectResponse])
...
@router.post("/{project_id}/renovation/photos", response_model=BaseResponse[RenovationPhotoResponse])
async def upload_renovation_photo(
    ...
    return BaseResponse(code=200, msg="success", data=photo)


@router.get("/{project_id}/renovation/photos", response_model=BaseResponse[List[RenovationPhotoResponse]])
async def get_renovation_photos(
    ...
    return BaseResponse(code=200, msg="success", data=photos)


# ========== 在售阶段管理 ==========

@router.put("/{project_id}/selling/roles", response_model=BaseResponse[ProjectResponse])
...
@router.post("/{project_id}/selling/viewings", response_model=BaseResponse[SalesRecordResponse])
...
@router.post("/{project_id}/selling/offers", response_model=BaseResponse[SalesRecordResponse])
...
@router.post("/{project_id}/selling/negotiations", response_model=BaseResponse[SalesRecordResponse])
...
@router.get("/{project_id}/selling/records", response_model=BaseResponse[List[SalesRecordResponse]])
...
@router.delete("/{project_id}/selling/records/{record_id}", response_model=BaseResponse)
...
async def get_project_report(
    ...
    return BaseResponse(code=200, msg="success", data=report)
