...
@pytest.fixture
def app_data(test_app):
    client, db = test_app
    return client, db


def _create_customer_token(db, username="testcustomer", phone="13900001111"):
    user = User(
        username=username,
...
class TestCurrentCustomerUserDep:
    ...
    def test_customer_role_user_passes_auth(self):
    ...
    def test_admin_role_user_rejected(self):
        from dependencies.auth import require_roles
        role_checker = require_roles(["customer"])
        user = MagicMock(spec=User)
        user.status = "active"
    ...
    def test_operator_role_user_rejected(self):
        from dependencies.auth import require_roles
        role_checker = require_roles(["customer"])
        user = MagicMock(spec=User)
        user.status = "active"
    ...
    def test_inactive_customer_user_rejected(self):
    ...
    def test_current_customer_user_dep_exists(self):
...
class TestCustomerRoleInitialization:
    ...
    def test_customer_role_exists_in_test_db(self, app_data):
        client, db = app_data
    ...
    def test_all_roles_exist(self, app_data):
        client, db = app_data
...
class TestPublicRegister:
    ...
    def test_register_success(self, app_data):
        client, db = app_data
        response = client.post("/api/v1/public/auth/register", json={
            "username": "newuser01",
            "password": "Test123!",
            "nickname": "测试用户",
            "phone": "13800001111",
    ...
    def test_register_username_conflict(self, app_data):
        client, db = app_data
...
class TestPublicLogout:
    ...
    def test_logout_success(self, app_data):
        client, db = app_data
        token, user = _create_customer_token(db, "logout_user", "13900002222")
    ...
    def test_logout_without_auth(self, app_data):
        client, db = app_data
...
class TestPublicProfile:
    ...
    def test_update_nickname(self, app_data):
        client, db = app_data
    ...
    def test_profile_phone_masked(self, app_data):
        client, db = app_data
...
class TestPublicPhone:
    ...
    def test_update_phone_success(self, app_data):
        client, db = app_data
    ...
    def test_update_phone_wrong_password(self, app_data):
        client, db = app_data
    ...
    def test_update_phone_already_bound(self, app_data):
        client, db = app_data
...
class TestPublicProjects:
    ...
    def test_get_projects_empty(self, app_data):
        client, db = app_data
    ...
    def test_get_projects_with_data(self, app_data):
        client, db = app_data
        community = Community(
            id="test-community-1",
            name="测试小区",
    ...
    def test_get_projects_filters_deleted(self, app_data):
        client, db = app_data
        community = Community(
    ...
    def test_get_projects_filters_draft(self, app_data):
        client, db = app_data
        community = Community(
    ...
    def test_get_projects_with_filters(self, app_data):
        client, db = app_data
        response = client.get("/api/v1/public/projects", params={
            "project_status": "在售",
            "community_name": "测试",
            "layout": "三室两厅",
            "min_price": 100,
...
class TestPublicProjectDetail:
    ...
    def test_get_project_detail(self, app_data):
        client, db = app_data
        community = Community(
    ...
    def test_get_project_not_found(self, app_data):
        client, db = app_data
...
class TestPublicConsultant:
    ...
    def test_get_consultant_with_assigned(self, app_data):
        client, db = app_data
        consultant = User(
    ...
    def test_get_consultant_default(self, app_data):
        client, db = app_data
        community = Community(
...
class TestPublicSoldProjects:
    ...
    def test_get_sold_projects(self, app_data):
        client, db = app_data
        community = Community(
    ...
    def test_sold_projects_only_sold_status(self, app_data):
        client, db = app_data
        response = client.get("/api/v1/public/projects/sold")
        data = response.json()
        for item in data["items"]:
...
class TestPublicPlatformStats:
    ...
    def test_get_platform_stats(self, app_data):
        client, db = app_data
...
class TestPublicCommunitySearch:
    ...
    def test_search_communities(self, app_data):
        client, db = app_data
        community = Community(
    ...
    def test_search_communities_empty(self, app_data):
        client, db = app_data
    ...
    def test_search_communities_with_limit(self, app_data):
        client, db = app_data
...
class TestPublicLeads:
    ...
    def test_create_lead(self, app_data):
        client, db = app_data
        token, user = _create_customer_token(db, "lead_user", "13900005551")
        response = client.post(
            "/api/v1/public/leads",
            json={
                "community_name": "估价小区",
    ...
    def test_create_lead_requires_auth(self, app_data):
        client, db = app_data
        response = client.post("/api/v1/public/leads", json={
            "community_name": "估价小区",
        })
        assert response.status_code == 401

    def test_create_lead_creator_id_auto_set(self, app_data):
        client, db = app_data
    ...
    def test_get_my_leads(self, app_data):
        client, db = app_data
        token, user = _create_customer_token(db, "my_leads_user", "13900005553")
        client.post(
            "/api/v1/public/leads",
    ...
    def test_get_lead_detail_own(self, app_data):
        client, db = app_data
        token, user = _create_customer_token(db, "detail_user", "13900005554")
    ...
    def test_get_lead_detail_others_forbidden(self, app_data):
        client, db = app_data
        token1, user1 = _create_customer_token(db, "owner_user", "13900005555")
        create_resp = client.post(
            "/api/v1/public/leads",
        ...
        token2, user2 = _create_customer_token(db, "other_user", "13900005556")
        response = client.get(
            f"/api/v1/public/leads/{lead_id}",
            headers={"Authorization": f"Bearer {token2}"},
        )
    ...
    def test_get_lead_detail_not_found(self, app_data):
        client, db = app_data
        token, user = _create_customer_token(db, "notfound_user", "13900005557")
        response = client.get(
