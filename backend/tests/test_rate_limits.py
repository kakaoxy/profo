...
def _check_has_rate_limit(func, name: str):
    ...
    assert hasattr(func, '__wrapped__'), (
        f"{name} 缺少 @limiter.limit() 速率限制装饰器"
    )
    ...
    assert has_limiter, (
        f"{name} 虽然存在 __wrapped__，但未检测到 slowapi Limiter 实例，"
        f"可能未被 @limiter.limit() 装饰"
    )
...
class TestUsersRateLimits:
    ...
    def test_existing_limits_unchanged_change_password(self):
...
class TestProjectsRateLimits:
    ...
    def test_update_renovation_stage_has_rate_limit(self):
    ...
    def test_delete_renovation_photo_has_rate_limit(self):
    ...
    def test_update_renovation_contract_has_rate_limit(self):
    ...
    def test_delete_cashflow_record_has_rate_limit(self):
...
class TestMarketingRateLimits:
    def test_create_marketing_project_has_rate_limit(self):
    ...
    def test_update_marketing_project_has_rate_limit(self):
    ...
    def test_delete_marketing_project_has_rate_limit(self):
    ...
    def test_update_marketing_media_has_rate_limit(self):
    ...
    def test_delete_marketing_media_has_rate_limit(self):
    ...
    def test_update_media_sort_order_has_rate_limit(self):
...
class TestMonitorRateLimits:
    def test_remove_competitor_has_rate_limit(self):
...
class TestMarketRateLimits:
    def test_merge_communities_has_rate_limit(self):
    ...
    def test_create_community_has_rate_limit(self):
